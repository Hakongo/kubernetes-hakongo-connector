...
import (
	...
	"github.com/hakongo/kubernetes-connector/internal/version"
...
func main() {
	...
	if showVersion {
		fmt.Printf("Kubernetes HakonGo Connector version: %s\n", version.GetVersion())
		os.Exit(0)
	}
	...
	setupLog.Info("starting manager", "version", version.GetVersion())
